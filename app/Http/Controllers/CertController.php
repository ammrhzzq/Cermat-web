...
class CertController extends Controller
{
    public function index(Request $request) {
        ...
        $certTypes = Certificate::select('cert_type')->distinct()->pluck('cert_type');
        $isoNumbers = Certificate::select('iso_num')->distinct()->pluck('iso_num');
        $companyNames = Certificate::select('comp_name')->distinct()->pluck('comp_name');
        
        // Get unique dates
        $regDates = Certificate::select('reg_date')->distinct()->pluck('reg_date');
        $issueDates = Certificate::select('issue_date')->distinct()->pluck('issue_date');
        $expDates = Certificate::select('exp_date')->distinct()->pluck('exp_date');
    ...
    public function store(Request $request){
        ...
        $newCert = Certificate::create($data);
